...
<html>
<head>
<title>create new account|dr</title>
<style type="text/css">
body{
...
<body>
<div id="frame">
<h><img src="http://i.imgur.com/ify43ph.png" height="30"/>CREATE NEW ACCOUNT|DR</h>
<hr width="95%"/>
<div id="form">
...
<br/><br/><br/><br/>
<input required="required" type="submit" name="signup" value="create new account" class="create"/>
</form>
</div>
</div>
</body>
